      ...
      >
        ...
        <div>
          ...
          <div className="flex gap-2.5">
            ...
            >
              <p
                className={`${sizes.includes("S") ? "bg-pink-100" : "bg-pink-200"} px-3 py-1 cursor-pointer`}
              >
                S
              </p>
            </div>
            ...
            >
              <p
                className={`${sizes.includes("M") ? "bg-pink-100" : "bg-pink-200"} px-3 py-1 cursor-pointer`}
              >
                M
              </p>
            </div>
            ...
            >
              <p
                className={`${sizes.includes("L") ? "bg-pink-100" : "bg-pink-200"} px-3 py-1 cursor-pointer`}
              >
                L
              </p>
            </div>
            ...
            >
              <p
                className={`${sizes.includes("XL") ? "bg-pink-100" : "bg-pink-200"} px-3 py-1 cursor-pointer`}
              >
                XL
              </p>
            </div>
            ...
            >
              <p
                className={`${sizes.includes("XXL") ? "bg-pink-100" : "bg-pink-200"} px-3 py-1 cursor-pointer`}
              >
                XXL
              </p>
            </div>
